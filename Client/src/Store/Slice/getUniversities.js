...
export const getUniversitiesInfo = createAsyncThunk("Universities", async (data) => {
 
  const alternative = 1;
  return axio.get(`/api/universities/?limit=${data.pageSize}&page=${data.pageIndex === 0 ? alternative:data.pageIndex}`);//
});
