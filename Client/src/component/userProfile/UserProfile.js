...
const Userprofile = () => {
 ...
 <div className="dashboard-content-container">
                <div className="left-container--dashboard--content">
                  <img className="quiz-img" src={dashImg}  ></img>
              ...
              <img className="quiz-img" src={contactImg} ></img>
          ...
          <div className="sub-container">
            ...
            <div className="sub-top">
                    ...
                    <div className="sub-top-1">
                      ...
                      <p className="sub-contain">Lörem ipsum kvasitropi svemester. Anaitet lall. Gåsade döloning. Syll bebel till kvasisens. Tres kos masade robotdräkt. Heteropp. Vönäna teraskap. Vande legga kadinera makrohet reatologi. Por hybridkrig och hypobun. Evöligt färade, därför att påns tilig.</p>
