...
import logo from "../Admission/Img/indianLogo.png";
import NTAlogo from "../Admission/Img/NTALogo.png";
  ...
  <Navbar />
        ...
        <div className="ad-sec-head">
          <div className="ad-but">
            <button className="ad-but-1" onClick={()=>{ const showItem = document.getElementById("show")
            showItem.style.display=showItem.style.display ==="none"?"block":"none"
        }}>MBBC</button>
            <button className="ad-but-2" onClick={()=>{ const showItem = document.getElementById("show2")
            showItem.style.display=showItem.style.display ==="none"?"block":"none"
        }}>BDC</button>
          </div>
        </div>
