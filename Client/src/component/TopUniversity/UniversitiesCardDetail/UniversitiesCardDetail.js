...
import "../UniversitiesCardDetail/UniversitiesCardDetail.css";
import UniLogo from "../UniversitiesCardDetail/Img/logo.png";
import eduLogo from "../UniversitiesCardDetail/Img/educationlogo.png";
import menu from "../UniversitiesCardDetail/Img/hamburger.png";
        ...
        <div className="clg-head-top">
          {/* <button
            ...
            onClick={() => {
              ...
              show.style.display =
                show.style.display === "none" ? "block" : "none";
            }}
          >
